...
open class Slider : UIControl {
      ...
      private func updateValueViewColor() {
            ...
            // MARK: EDITED FROM ORIGINAL
            valueView.outerFillColor = UIColor.white //contentViewColor
            //
      ...
      open func initializeLabels() {
            minimumLabel.font = UIFont(name: "Helvetica", size: minimumLabel.font.pointSize)
            minimumLabel.textColor = UIColor.darkGray
            maximumLabel.font = UIFont(name: "Helvetica", size: minimumLabel.font.pointSize)
            maximumLabel.textColor = UIColor.darkGray
      }
      ...
      private func layoutValueView() {
            ...
            valueView.layer.shadowOffset = CGSize(width: 0, height: 0)
            valueView.layer.shadowRadius = 2
            valueView.layer.shadowOpacity = 0.75
            valueView.layer.shadowColor = UIColor.gray.cgColor
      }
